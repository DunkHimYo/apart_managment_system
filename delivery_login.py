...
class delivery_login(ttk.Frame):
    ...
    def __init__(self, parent, controller, log):
        ...
        self.list = ['번호', '아이디', '운송번호', '받는사람', '전화 번호', '도착지', '현재위치']
    ...
    def table_put(self):
        self.controller.controller.show_frame("table")

    def start_put(self):
        self.controller.controller.show_frame("StartPage")
