...
class resident_write_board(ttk.Frame):
    ...
    def home_put(self):
        self.controller.controller.show_frame('resident_board')
        self.clearTextInput()
    ...
    def insert(self):
        ...
        self.controller.controller.cur.execute('insert into 주민게시판 values %s' % str(tuple(b)))
